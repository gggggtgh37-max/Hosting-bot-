...
# --- Configuration ---
TOKEN = '8075817477:AAF24b1DmhS9ZcOYCNmFiw8QSastcSqZnx0' # Replace with your actual token
...
DATABASE_PATH = os.path.join(IROTECH_DIR, 'HOST_DATA')
